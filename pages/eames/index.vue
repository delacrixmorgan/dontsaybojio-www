    ...
    <section class='text-gray-600 body-font overflow-hidden'>
      <div class='container px-5 py-24 mx-auto'>
        <div class='lg:w-4/5 mx-auto flex flex-wrap'>
          <img alt='ecommerce' class='lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded hidden'
               src='https://dummyimage.com/400x400'>

          <model-viewer
            id='viewer'
            class='viewer lg:w-4/5 mx-auto flex flex-wrap'
          ...
          <div class='lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0'>
            <h2 class='text-sm title-font text-gray-500 tracking-widest'>FERCO</h2>
            <h1 class='text-gray-900 text-3xl title-font font-medium mb-1'>Milano Cushion Chair</h1>
            <div class='flex mb-4'>
          <span class='flex items-center'>
            ...
            <div class='flex'>
              <span class='title-font font-medium text-2xl text-gray-900'>RM699.00</span>
              <button
                class='flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded'>
                <a :href='lazadaLink' target='_blank'>Buy at Lazada</a>
              </button>
              <button
...
export default {
  data() {
    return {
      ...
      selectedVariant: '',
      variants: [],
      lazadaLink: 'https://www.lazada.com.my/products/pre-order-ferco-home-milano-home-office-electric-recliner-chair-with-swivel-laptop-table-usb-charging-port-cup-holder-perfect-for-work-from-home-eta-2021-07-1-i1541872210-s5171506560.html?spm=a2o4k.searchlist.list.21.4f19d439zKsAcp&search=1'
    }
  },
  mounted() {
